...
public class ClassFileImporterGenericCodeUnitParameterTypesTest {
    ...
    public static Object[][] data_imports_generic_code_unit_parameter_type_with_one_type_argument() {
        @SuppressWarnings("unused")
        class GenericParameterType<T> {
        }
        @SuppressWarnings("unused")
        class GenericSignatureOnConstructor {
            GenericSignatureOnConstructor(GenericParameterType<String> param) {
            }
        }
        @SuppressWarnings("unused")
        class GenericSignatureOnMethod {
            void method(GenericParameterType<String> param) {
            }
        }
        ...
        Object[][] testCases = testCasesFromSameGenericSignatureOnConstructorAndMethod(
                ...
                GenericParameterType.class, String.class);
        return $$(
                $(testCases[0][0], GenericParameterType.class),
                $(testCases[1][0], GenericParameterType.class)
        );
    }

    @Test
    @UseDataProvider
    public void test_imports_generic_code_unit_parameter_type_with_one_type_argument(JavaCodeUnit codeUnit, Class<?> expectedParameterTypeErasure) {
        ...
        assertThatType(genericParameterType).as("generic parameter type")
                .hasErasure(expectedParameterTypeErasure)
    ...
    public void imports_raw_parameter_types_and_generic_parameter_types_of_inner_class_constructor_like_Reflection_API() {
        ...
        class LocalClassThatWillHaveEnclosingClassAsFirstRawConstructorParameter {
            public LocalClassThatWillHaveEnclosingClassAsFirstRawConstructorParameter(GenericParameterType<String> param) {
            }
        }
        ...
        JavaConstructor constructor = new ClassFileImporter()
                .importClasses(
                        ...
                        getClass(), GenericParameterType.class, String.class)
                .get(LocalClassThatWillHaveEnclosingClassAsFirstRawConstructorParameter.class)
                .getConstructor(getClass(), GenericParameterType.class);

        // raw parameter types
        assertThatTypes(constructor.getRawParameterTypes()).matchExactly(getClass(), GenericParameterType.class);

        // generic parameter types
        assertThat(constructor.getParameterTypes()).hasSize(1);
        assertThatType(constructor.getParameterTypes().get(0)).matches(
                parameterizedType(GenericParameterType.class).withTypeArguments(String.class));
    }
    ...
    public static Object[][] data_imports_raw_generic_code_unit_parameter_type_as_JavaClass_instead_of_JavaParameterizedType() {
        ...
        class GenericSignatureOnConstructor {
            GenericSignatureOnConstructor(GenericParameterType param) {
            }
        }
        @SuppressWarnings({"unused", "rawtypes"})
        class GenericSignatureOnMethod {
            void method(GenericParameterType param) {
            }
        }
    ...
    @Test
    @UseDataProvider
    public void test_imports_raw_generic_code_unit_parameter_type_as_JavaClass_instead_of_JavaParameterizedType(JavaCodeUnit codeUnit, Class<?> expectedParameterTypeErasure) {
        JavaType rawGenericParameterType = codeUnit.getParameterTypes().get(0);

        assertThatType(rawGenericParameterType).as("raw generic parameter type").matches(expectedParameterTypeErasure);
    }
    ...
    @Test
    @UseDataProvider
    public void test_imports_generic_code_unit_parameter_type_with_array_type_argument(JavaCodeUnit codeUnit, Class<?> expectedParameterTypeErasure) {
    ...
    public static Object[][] data_imports_generic_code_unit_parameter_type_with_primitive_array_type_argument() {
        ...
        @SuppressWarnings("unused")
        class GenericSignatureOnConstructor {
            GenericSignatureOnConstructor(GenericParameterType<int[]> param) {
            }
        }
        @SuppressWarnings("unused")
        class GenericSignatureOnMethod {
            void method(GenericParameterType<int[]> param) {
            }
        }
    ...
    @Test
    @UseDataProvider
    public void test_imports_generic_code_unit_parameter_type_with_primitive_array_type_argument(JavaCodeUnit codeUnit, Class<?> expectedParameterTypeErasure) {
        JavaType genericMethodParameterType = codeUnit.getParameterTypes().get(0);
    ...
    public static Object[][] data_imports_generic_code_unit_parameter_type_with_multiple_type_arguments() {
        @SuppressWarnings("unused")
        class GenericParameterType<A, B, C> {
        }
        @SuppressWarnings("unused")
        class GenericSignatureOnConstructor {
            GenericSignatureOnConstructor(GenericParameterType<String, Serializable, File> param) {
            }
        }
        @SuppressWarnings("unused")
        class GenericSignatureOnMethod {
            void method(GenericParameterType<String, Serializable, File> param) {
            }
        }
        ...
        Object[][] testCases = testCasesFromSameGenericSignatureOnConstructorAndMethod(
                GenericSignatureOnConstructor.class,
                GenericSignatureOnMethod.class,
                GenericParameterType.class, Serializable.class, File.class, String.class);
        return $$(
                $(testCases[0][0], GenericParameterType.class),
                $(testCases[1][0], GenericParameterType.class)
        );
    ...
    @Test
    @UseDataProvider
    public void test_imports_generic_code_unit_parameter_type_with_multiple_type_arguments(JavaCodeUnit codeUnit, Class<?> expectedParameterTypeErasure) {
        JavaType genericParameterType = codeUnit.getParameterTypes().get(0);
    ...
    public static Object[][] data_imports_generic_code_unit_parameter_type_with_single_actual_type_argument_parameterized_with_concrete_class() {
        ...
        @SuppressWarnings("unused")
        class GenericSignatureOnConstructor {
            GenericSignatureOnConstructor(GenericParameterType<ClassParameterWithSingleTypeParameter<String>> param) {
            }
        }
        @SuppressWarnings("unused")
        class GenericSignatureOnMethod {
            void method(GenericParameterType<ClassParameterWithSingleTypeParameter<String>> param) {
            }
        }
        ...
        return testCasesFromSameGenericSignatureOnConstructorAndMethod(
                GenericSignatureOnConstructor.class,
                GenericSignatureOnMethod.class,
                GenericParameterType.class, ClassParameterWithSingleTypeParameter.class, String.class);
    }
    ...
    public static Object[][] data_imports_generic_code_unit_parameter_type_with_multiple_actual_type_arguments_parameterized_with_concrete_classes() {
        ...
        @SuppressWarnings("unused")
        class GenericSignatureOnConstructor {
            GenericSignatureOnConstructor(GenericParameterType<
        ...
        @SuppressWarnings("unused")
        class GenericSignatureOnMethod {
            void method(GenericParameterType<
                    ClassParameterWithSingleTypeParameter<File>,
                    InterfaceParameterWithSingleTypeParameter<Serializable>,
                    InterfaceParameterWithSingleTypeParameter<String>> param) {
            }
        ...
        return testCasesFromSameGenericSignatureOnConstructorAndMethod(
                GenericSignatureOnConstructor.class,
                GenericSignatureOnMethod.class,
                GenericParameterType.class, ClassParameterWithSingleTypeParameter.class, InterfaceParameterWithSingleTypeParameter.class,
    ...
    public static Object[][] data_imports_generic_code_unit_parameter_type_with_single_actual_type_argument_parameterized_with_unbound_wildcard() {
        ...
        @SuppressWarnings("unused")
        class GenericSignatureOnConstructor {
            GenericSignatureOnConstructor(GenericParameterType<ClassParameterWithSingleTypeParameter<?>> param) {
            }
        }
        @SuppressWarnings("unused")
        class GenericSignatureOnMethod {
            void method(GenericParameterType<ClassParameterWithSingleTypeParameter<?>> param) {
            }
        }
        ...
        return testCasesFromSameGenericSignatureOnConstructorAndMethod(
                GenericSignatureOnConstructor.class,
                GenericSignatureOnMethod.class,
                GenericParameterType.class, ClassParameterWithSingleTypeParameter.class);
    }
    ...
    public static Object[][] data_imports_generic_code_unit_parameter_type_with_actual_type_arguments_parameterized_with_bounded_wildcards() {
        @SuppressWarnings("unused")
        class GenericParameterType<A, B> {
        }
        @SuppressWarnings("unused")
        class GenericSignatureOnConstructor {
            GenericSignatureOnConstructor(GenericParameterType<
        ...
        return testCasesFromSameGenericSignatureOnConstructorAndMethod(
                GenericSignatureOnConstructor.class,
                GenericSignatureOnMethod.class,
                GenericParameterType.class, ClassParameterWithSingleTypeParameter.class, String.class, File.class);
    }
    ...
    public static Object[][] data_imports_generic_code_unit_parameter_type_with_actual_type_arguments_with_multiple_wildcards_with_various_bounds() {
        ...
        return testCasesFromSameGenericSignatureOnConstructorAndMethod(
                GenericSignatureOnConstructor.class,
                GenericSignatureOnMethod.class,
                GenericParameterType.class, ClassParameterWithSingleTypeParameter.class, Map.class, Serializable.class, File.class, Reference.class, String.class);
    }
    ...
    public static Object[][] data_imports_generic_code_unit_parameter_type_parameterized_with_type_variable() {
        ...
        class GenericSignatureOnConstructor<OF_CLASS> {
            GenericSignatureOnConstructor(GenericParameterType<OF_CLASS> param) {
            }
        }
        @SuppressWarnings("unused")
        class GenericSignatureOnMethod<OF_CLASS> {
            void method(GenericParameterType<OF_CLASS> param) {
            }
        }
    ...
    public static Object[][] data_imports_generic_code_unit_parameter_type_with_actual_type_argument_parameterized_with_type_variable() {
        ...
        @SuppressWarnings("unused")
        class GenericSignatureOnConstructor<OF_CLASS> {
            GenericSignatureOnConstructor(GenericParameterType<ClassParameterWithSingleTypeParameter<OF_CLASS>> param) {
            }
        }
        @SuppressWarnings("unused")
        class GenericSignatureOnMethod<OF_CLASS> {
            void method(GenericParameterType<ClassParameterWithSingleTypeParameter<OF_CLASS>> param) {
            }
        }
    ...
    public static Object[][] data_references_outer_type_variable_assigned_to_actual_type_argument_of_generic_code_unit_parameter_type_of_inner_class() {
        ...
        class OuterWithTypeParameter<OUTER extends String> {
            class SomeInner {
                ...
                class GenericSignatureOnConstructor {
                    GenericSignatureOnConstructor(GenericParameterType<OUTER> param) {
                    }
                }

                class GenericSignatureOnMethod {
                    void method(GenericParameterType<OUTER> param) {
                    }
                }
            }
        }
        ...
        return testCasesFromSameGenericSignatureOnConstructorAndMethod(
                ...
                OuterWithTypeParameter.class, OuterWithTypeParameter.SomeInner.class, OuterWithTypeParameter.SomeInner.GenericParameterType.class, String.class);
    }
    ...
    public static Object[][] data_creates_new_stub_type_variables_for_type_variables_of_enclosing_classes_that_are_out_of_context_for_generic_code_unit_parameter_type_of_inner_class() {
        ...
        return testCasesFromSameGenericSignatureOnConstructorAndMethod(
                OuterWithTypeParameter.SomeInner.GenericSignatureOnConstructor.class,
                OuterWithTypeParameter.SomeInner.GenericSignatureOnMethod.class,
                OuterWithTypeParameter.SomeInner.GenericParameterType.class, String.class);
    }
    ...
    public static Object[][] data_imports_wildcards_of_generic_code_unit_parameter_type_bound_by_type_variables() {
        ...
        return testCasesFromSameGenericSignatureOnConstructorAndMethod(
                GenericSignatureOnConstructor.class,
                GenericSignatureOnMethod.class,
                GenericParameterType.class, ClassParameterWithSingleTypeParameter.class, String.class, Serializable.class);
    }
    ...
    public static Object[][] data_imports_wildcards_of_generic_code_unit_parameter_type_bound_by_type_variables_of_enclosing_classes() {
        ...
        return testCasesFromSameGenericSignatureOnConstructorAndMethod(
                OuterWithTypeParameter.SomeInner.GenericSignatureOnConstructor.class,
                OuterWithTypeParameter.SomeInner.GenericSignatureOnMethod.class,
                OuterWithTypeParameter.class, OuterWithTypeParameter.SomeInner.class, OuterWithTypeParameter.SomeInner.GenericParameterType.class,
    ...
    public static Object[][] data_creates_new_stub_type_variables_for_wildcards_bound_by_type_variables_of_enclosing_classes_that_are_out_of_context() {
        ...
        return testCasesFromSameGenericSignatureOnConstructorAndMethod(
                OuterWithTypeParameter.SomeInner.GenericSignatureOnConstructor.class,
                OuterWithTypeParameter.SomeInner.GenericSignatureOnMethod.class,
                OuterWithTypeParameter.SomeInner.GenericParameterType.class, ClassParameterWithSingleTypeParameter.class, String.class, Serializable.class);
    }
    ...
    public static Object[][] data_imports_complex_generic_code_unit_parameter_type_with_multiple_nested_actual_type_arguments_with_self_referencing_type_definitions() {
        ...
        return testCasesFromSameGenericSignatureOnConstructorAndMethod(
                GenericSignatureOnConstructor.class,
                GenericSignatureOnMethod.class,
                GenericParameterType.class, String.class, Serializable.class, Cloneable.class, List.class, Map.class, Map.Entry.class, Set.class, Iterable.class, Comparable.class);
    }
    ...
    public static Object[][] data_imports_complex_generic_code_unit_parameter_type_with_multiple_nested_actual_type_arguments_with_concrete_array_bounds() {
        ...
        return testCasesFromSameGenericSignatureOnConstructorAndMethod(
                GenericSignatureOnConstructor.class,
                GenericSignatureOnMethod.class,
                GenericParameterType.class, List.class, Serializable.class, Map.class, String.class);
    }
    ...
    public static Object[][] data_imports_generic_code_unit_parameter_type_with_parameterized_array_bounds() {
        ...
        @SuppressWarnings("unused")
        class GenericSignatureOnConstructor {
            GenericSignatureOnConstructor(GenericParameterType<List<String>[], List<String[]>[][], List<String[][]>[][][]> param) {
            }
        }
        @SuppressWarnings("unused")
        class GenericSignatureOnMethod {
            void method(GenericParameterType<List<String>[], List<String[]>[][], List<String[][]>[][][]> param) {
            }
        }
        ...
        return testCasesFromSameGenericSignatureOnConstructorAndMethod(
                GenericSignatureOnConstructor.class,
                GenericSignatureOnMethod.class,
                GenericParameterType.class, List.class, String.class);
    }
    ...
    public static Object[][] data_imports_multiple_generic_code_unit_parameter_types() {
        ...
        class GenericSignatureOnConstructor<FIRST extends String & Serializable, SECOND extends Serializable & Cloneable> {
            GenericSignatureOnConstructor(
                    GenericParameterType<List<? extends FIRST>> first,
                    GenericParameterType<
                            Map<
                                    ...
                                    >
                            > second,
                    GenericParameterType<Comparable<GenericSignatureOnConstructor<FIRST, SECOND>>> third) {
            }
        }
        @SuppressWarnings("unused")
        class GenericSignatureOnMethod<FIRST extends String & Serializable, SECOND extends Serializable & Cloneable> {
            void method(
                    ...
                    GenericParameterType<
                            Map<
                                    ...
                                    >
                            > second,
                    GenericParameterType<Comparable<GenericSignatureOnMethod<FIRST, SECOND>>> third) {
            }
        }
        ...
        return testCasesFromSameGenericSignatureOnConstructorAndMethod(
                GenericSignatureOnConstructor.class,
                GenericSignatureOnMethod.class,
                GenericParameterType.class, String.class, Serializable.class, Cloneable.class,
